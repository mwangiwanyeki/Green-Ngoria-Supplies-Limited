...
function buildColumns(handlers: RowHandlers): ColumnDef<Client>[] {
  return [
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="text-xs text-muted-foreground space-y-0.5">
            ...
            <div>
              {c.quotations} quotation{c.quotations !== 1 ? 's' : ''}
            </div>
          </div>
        );
      },
    ...
    },
    {
      ...
      header: '',
      cell: ({ row }) => (
        <RowActions client={row.original} handlers={handlers} />
      ),
    },
  ];
}
...
export function AdminClientsList() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast.error(
        getApiErrorMessage(
          err,
          editing ? 'Could not update client' : 'Could not create client',
        ),
      );
    }
  }
  ...
  function handleExport() {
    ...
    a.href = url;
    a.download = `clients-${format(new Date(), 'yyyyMMdd')}.csv`;
    a.click();
          ...
          >
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="e.g. Acacia Mining Ltd"
            ...
            <div className="space-y-1.5">
              ...
              <Input
                value={miningInterest}
                onChange={(e) => setMiningInterest(e.target.value)}
    ...
    <Dialog open onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a contact person for this client. Mark as primary to display
            them in the client list.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="e.g. Mining Director, Procurement Manager"
              className="h-9 text-sm"
            />
          </div>
