...
export function AdminAccounts() {
  ...
  const [manualEntryAccount, setManualEntryAccount] =
      ...
      cell: (r) => (
        <div className="flex items-center justify-end gap-1">
          ...
          <Button
            ...
            title="Manual entry"
            onClick={() => setManualEntryAccount(r)}
          >
    ...
    <>
        ...
        actions={
          <>
            <Button
              ...
              onClick={() =>
                toast.info('Select a row to record a manual entry')
              }
            >
              Manual Entry
            </Button>
      ...
      {viewAccount && (
        <AccountDetailDialog
          ...
          onManualEntry={() => {
            setManualEntryAccount(viewAccount);
            setViewAccount(null);
          }}
        />
      )}
...
function AccountFormDialog({
  ...
  const [type, setType] = React.useState<AccountType>(
    (account?.type as AccountType) ?? 'CASH',
  );
    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEdit
              ? 'Update account details. Balance only moves through transactions.'
              : 'Create a cash, bank, mobile money or other financial account.'}
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="e.g. M-Pesa Till, KCB Current Account"
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="Till / IBAN / sort code"
                className="h-9 text-sm"
              />
            </div>
            {!isEdit && (
        ...
        >
          ...
          <div className="space-y-1.5">
            ...
            <Input
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              placeholder="e.g. Cash banked from till"
              className="h-9 text-sm"
              maxLength={500}
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Slip no., M-Pesa code…"
              className="h-9 text-sm"
              maxLength={120}
            />
          </div>
            ...
            <div className="rounded-lg border border-border bg-muted/20 p-3 text-sm space-y-1.5">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">
                  {entryType === 'CREDIT' ? 'Adding' : 'Removing'}
                </span>
                <span
                  className={cn(
              ...
              <div className="flex justify-between border-t border-border pt-1.5 font-semibold">
                ...
                <span
                  className={cn(
                    'tabular-nums',
                    projected < 0 ? 'text-destructive' : 'text-success',
                  )}
                >
                  {formatKsh(projected)}
                </span>
