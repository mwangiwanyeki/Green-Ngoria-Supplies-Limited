...
export const serviceDivisions: ServiceDivision[] = [
  {
    ...
    headline:
      'Active gold vein mining, concessions and mineral processing across East Africa',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Refined gold doré bullion bar smelted and poured directly from Green Ngoria’s operating Bondo gold facility.',
    ...
    keyMetrics: [
      {
        ...
        detail: 'Bondo, Taita Taveta & Tanzanian Assets',
      },
      {
      ...
      {
        label: 'Extraction Circuits',
        value: 'CIP / CIL / Gravity',
        detail: 'Shaking Tables & Cyanidation',
      },
      {
        label: 'Licensing Status',
        value: 'Stamp Duty Paid',
        detail: 'Ministry of Mining Compliance',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'Poured gold doré bar smelted on site from Bondo processing plant output.',
        tag: 'Gold Doré',
      },
      {
        ...
        caption:
          'Coarse native gold nuggets recovered through gravity sluicing and optical sorting.',
        tag: 'Native Gold',
      },
      {
      ...
      },
      {
        ...
        caption:
          'High-grade gold ore specimen showing visible gold mineralization in quartz matrix.',
        tag: 'Ore Geology',
      },
      {
        ...
        caption:
          'Deep exploration diamond drill rig investigating orebody continuity and grade.',
        tag: 'Exploration',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            description:
              'Vertical and inclined shaft sinking with reinforced timbering, hoisting gear, and ventilation.',
          },
          {
            name: 'Open-Cast & Alluvial Extraction',
            standard: 'Civil Earthworks',
            description:
              'Excavation of surface ore deposits and alluvial gravel beds feeding primary scrubbers.',
          },
          {
            name: 'CIP/CIL Processing & Smelting',
            standard: 'NEMA Approved',
            description:
              'Closed-circuit crushing, ball milling, gravity concentrators, CIL cyanidation, and bullion smelting.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Trenching, geochemical soil sampling, and structural vein mapping across concession coordinates.',
      ...
      },
      {
        ...
        objective:
          'Excavate access shaft, install hoisting headframes, and establish ventilation and dewatering.',
      ...
      },
      {
        ...
        objective:
          'Extract gold-bearing ore, crush, mill, and recover doré bullion at the Bondo facility.',
        deliverables: [
    ...
    technicalSpecs: [
      {
        parameter: 'Target Commodities',
        standardValue: 'Gold (Au), Silver (Ag) by-product',
        engineeringNotes: 'Primary quartz vein and alluvial deposits',
      },
      {
        parameter: 'Environmental Licence',
        standardValue: 'NEMA/PR/SYA/002',
        engineeringNotes: 'Issued by County Director of Environment, Siaya',
      },
      {
        parameter: 'Doré Bullion Purity',
        standardValue: '88% – 96% Au content prior to refining',
        engineeringNotes: 'Directly smelted using induction furnaces',
      },
    ],
    groups: [
      {
        ...
        description:
          'The six strategic pillars that guide Green Ngoria’s mining operations.',
        items: [
    ...
    faqs: [
      {
        ...
        answer:
          'Yes. We engage with institutional investors and joint-venture partners on concession expansion, exploration drilling, and processing plant upgrades.',
      },
      {
        question:
          'How is environmental protection maintained at the Bondo processing plant?',
        answer:
          'The plant operates under NEMA approval Ref: NEMA/PR/SYA/002, featuring impermeable lined tailings containment, cyanide destruction protocols, and zero untreated discharge.',
      },
    ],
    cta: { label: 'Discuss a Mining Opportunity', href: '/contact' },
    secondaryCta: {
      label: 'Explore Bondo Processing Plant',
...

  {
    ...
    eyebrow: 'Mining Operations',
    headline:
      'International gemstone mining, concession development and marketing',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'International-grade faceted Tanzanite gemstones mined from company-owned concessions.',
    ...
    keyMetrics: [
      {
        label: 'Company Mines',
        value: '2 Concessions',
        detail: 'Kenya & Tanzania Assets',
      },
      {
        label: 'Varieties',
        value: '5 Precious Species',
        detail: 'Tanzanite, Tsavorite, Sapphire, Ruby',
      },
      {
        label: 'Grading Framework',
        value: 'GIA Standard',
        detail: 'Color, Clarity, Cut & Carat',
      },
      {
        label: 'Traceability',
        value: '100% Provenance',
        detail: 'Direct Mine-to-Market',
      },
    ],
    gallery: [
      {
        ...
        items: [
          {
            ...
            description:
              'Mined from Tanzanian concession; rough crystal specimens and calibrated faceted gemstones.',
          },
          {
            name: 'Tsavorite Garnet (Grossular Species)',
            standard: 'Vivid Emerald Green',
            description:
              'Mined from Taita Taveta belt in Kenya; exceptional brilliance and untreated natural color.',
          },
          {
            name: 'Corundum (Sapphire & Ruby)',
            standard: 'Mohs Hardness 9.0',
            description:
              'Fine blue sapphires and deep red rubies extracted from pegmatite and metamorphic host rocks.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Follow gem-bearing pegmatite and hydrothermal veins with controlled non-explosive extraction.',
      ...
      },
      {
        ...
        objective:
          'Clean, sort rough crystals by color, clarity, and facet potential under gemological daylight.',
      ...
      },
      {
        ...
        objective:
          'Cut and polish top-grade rough into certified gemstones with official Ministry of Mining export permits.',
    ...
    technicalSpecs: [
      {
        parameter: 'Hardness Range (Mohs Scale)',
        standardValue: '7.0 – 9.0 (Garnet to Corundum)',
        engineeringNotes: 'Ideal for fine jewelry and collectors',
      },
      {
        parameter: 'Grading Standard',
        standardValue: '4Cs (Color, Clarity, Cut, Carat)',
        engineeringNotes: 'Master color sets used for calibration',
      },
      {
        parameter: 'Treatment Policy',
        standardValue: '100% Disclosure of any thermal treatment',
        engineeringNotes: 'Guaranteed natural untreated Tsavorite and Sapphire',
      },
    ],
    groups: [
      {
        ...
        description:
          'Rough crystals and precision-cut gemstones marketed to international gem merchants.',
        items: [
    ...
    faqs: [
      {
        question:
          'How do international buyers purchase gemstone parcels from Green Ngoria?',
        answer:
          'We accommodate private viewing at our Nairobi corporate office or arrange insured international courier delivery with statutory export clearances.',
      },
      {
        question:
          'Are all gemstones supplied with export documentation and royalty receipts?',
        answer:
          'Yes. Every parcel is exported with verified mining provenance, mineral dealer licences, and official royalty documentation.',
      },
    ],
...

  {
    ...
    headline:
      'Commercial, institutional, and high-security building construction across East Africa',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Modern commercial and residential multi-storey complex delivered with structural reinforced concrete and glass facades.',
      badge: 'Turnkey Building EPC',
    },
    keyMetrics: [
      {
        label: 'Regional Delivery',
        value: 'Kenya, Rwanda, Burundi',
        detail: 'Cross-Border Institutional Contracts',
      },
      {
        label: 'Banking Portfolio',
        value: 'Bank of Kigali & BPR',
        detail: 'Fina Bank & Soras HQ Fit-Outs',
      },
      {
        label: 'Structural Concrete',
        value: 'BS 8110 / Eurocode',
        detail: 'Reinforced Framing & Lift Cores',
      },
      {
        label: 'Workforce',
        value: 'Qualified Site Engineers',
        detail: 'Permanent Construction Staff',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'Grand Park modern multi-storey commercial & residential complex.',
      ...
      },
      {
        ...
        caption:
          'Turnkey residential villas designed and constructed from foundation to finishes.',
        tag: 'Residential',
      },
      {
        ...
        caption:
          'Institutional facilities, schools, and diocesan administration buildings.',
        tag: 'Institutional',
      },
      {
        ...
        caption:
          'Nairobi commercial office developments, high-traffic finishes, and fit-outs.',
        tag: 'Office Fit-Out',
      },
      {
        ...
        caption:
          'Multi-storey structural framing, masonry infill, and roofing erection.',
        ...
        items: [
          {
            ...
            description:
              'Foundation pads, shear walls, columns, suspended slabs, and lift core engineering.',
          },
          {
            name: 'Architectural Glazing & Curtain Walling',
            standard: 'BS 6262 / ASTM E330',
            description:
              'Thermally broken aluminium frames, double-glazed low-E safety glass, and frameless entries.',
          },
          {
            name: 'Banking & High-Security Interior Fit-Out',
            standard: 'KPDA Security Specs',
            description:
              'Bullet-resistant teller counters, reinforced vault walls, access control, and acoustic partitioning.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Verify architectural/structural drawings, conduct soil tests, and establish perimeter security.',
      ...
      },
      {
        ...
        objective:
          'Excavate foundations, cast base plinths, erect columns, and pour suspended floor slabs.',
        deliverables: [
          'Concrete Cube Test Sheets',
          'Rebar Inspection Signoffs',
        ],
      ...
      },
      {
        ...
        objective:
          'Install curtain walling, exterior masonry, drywall partitioning, mechanical lift, and electrical wiring.',
      ...
      },
      {
        ...
        objective:
          'Complete painting, joinery, flooring, commission building services, and clear punch list items.',
        deliverables: [
          'As-Built Drawing Dossier',
    ...
    technicalSpecs: [
      {
        ...
        standardValue: 'C25/30 for slabs, C35/45 for heavy columns & plinths',
        engineeringNotes: 'Batch plant quality tested',
      },
      {
        parameter: 'Reinforcing High-Tensile Steel',
        standardValue: 'Grade 500B (BS 4449)',
        engineeringNotes: '100% mill test certificates verified',
      },
      {
        parameter: 'Curtain Wall Wind Load Resistance',
        standardValue: 'Up to 2.4 kPa positive/negative pressure',
        engineeringNotes: 'Engineered for high-rise commercial structures',
      },
    ],
    faqs: [
      {
        question:
          'Can Green Ngoria handle cross-border building projects in East Africa?',
        answer:
          'Yes. We have completed projects across Rwanda, Burundi, Uganda, and Kenya, coordinating international procurement, regional logistics, and on-site engineering crews.',
      },
      {
        question: 'Does Green Ngoria undertake design-and-build contracts?',
        answer:
          'Yes. We provide turnkey design-and-build delivery coordinating architectural concepts, structural engineering, statutory county approvals, and construction.',
      },
    ],
...

  {
    ...
    eyebrow: 'Construction',
    headline:
      'Commercial interior refurbishment, epoxy floors, acoustic ceilings, and structural restoration',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Commercial interior renovation showcasing epoxy resin floor application and architectural acoustic ceiling grid installation.',
      badge: 'Commercial Restoration',
    },
    keyMetrics: [
      {
        label: 'Renovation Portfolio',
        value: 'Corporate & Banking',
        detail: 'Bank of Kigali, BPR & Soras HQ',
      },
      {
        label: 'Flooring Systems',
        value: 'Heavy Duty Epoxy',
        detail: 'Chemical, Traffic & Slip Resistant',
      },
      {
        label: 'Acoustic Ceilings',
        value: 'NRC 0.75+ Rated',
        detail: 'Suspended Grid & Drywall Systems',
      },
      {
        label: 'Execution Speed',
        value: 'Phased Live Fit-Out',
        detail: 'Zero Downtime to Client Operations',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'High-end interior renovation, epoxy floor coating, and acoustic ceiling installation.',
      ...
      },
      {
        ...
        caption:
          'Weatherproof elastomeric painting and facade restoration on multi-storey property.',
      ...
      },
      {
        ...
        caption:
          'Refurbishment of institutional administration blocks, floor tiling, and partitions.',
        tag: 'Refurbishment',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            standard: 'BS 8204-6',
            description:
              'Self-leveling 2mm to 4mm solvent-free epoxy providing seamless hygiene and chemical resistance.',
          },
          {
            name: 'Acoustic Drywall & Glazed Partitions',
            standard: 'ASTM C840 / BS 5234',
            description:
              'Sound-damped partition walls (STC 45+) with integrated cable raceways and vision panels.',
          },
          {
            name: 'Weatherproof Elastomeric Coatings',
            standard: 'ISO 12944 / ASTM D412',
            description:
              'High-build flexible exterior coatings bridging hairline masonry cracks and preventing moisture ingress.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Evaluate moisture levels in concrete, assess old coatings, and prepare phased staging plan.',
      ...
      },
      {
        ...
        objective:
          'Diamond grind concrete floors, strip defective coatings, and repair structural masonry defects.',
      ...
      },
      {
        ...
        objective:
          'Apply primer and epoxy screeds, erect ceilings, install partitions, and apply paint finishes.',
        deliverables: [
          'Dry Film Thickness (DFT) Log',
          'Color Consistency Signoff',
        ],
      ...
      },
      {
        ...
        objective:
          'Perform final touchups, clean site, and deliver warranty documentation to the client.',
    ...
    technicalSpecs: [
      {
        parameter: 'Epoxy Coating Compressive Strength',
        standardValue: '> 60 N/mm²',
        engineeringNotes: 'Withstands heavy forklift and pallet truck traffic',
      },
      {
        parameter: 'Paint VOC Compliance',
        standardValue: '< 50 g/L (Low-VOC eco-friendly formulations)',
        engineeringNotes: 'Safe for indoor occupied building renovations',
      },
      {
        parameter: 'Acoustic Ceiling Noise Reduction Coefficient',
        standardValue: 'NRC 0.70 – 0.85',
        engineeringNotes: 'Reduces echo in open-plan corporate banking halls',
      },
    ],
    faqs: [
      {
        question:
          'Can Green Ngoria execute renovation works while building tenants remain in operation?',
        answer:
          'Yes. We frequently execute phased night-shift and weekend renovations with dust-containment partitions to ensure zero disruption to live business operations.',
      },
    ],
    cta: { label: 'Request a Renovation Proposal', href: '/contact' },
    secondaryCta: {
      label: 'See Building Portfolio',
...

  {
    ...
    eyebrow: 'Civil Works',
    headline:
      'Highways, urban paved roads, bridges, box culverts and major storm drainage',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Sub-base layer compaction using heavy vibratory roller to achieve required California Bearing Ratio (CBR) density.',
      badge: 'Civil Earthworks & Roads',
    },
    keyMetrics: [
      {
        label: 'Pavement Types',
        value: 'Asphaltic Concrete',
        detail: 'Surface Dressing, Overlays & Bitumen',
      },
      {
        label: 'Hydraulic Structures',
        value: 'Bridges & Culverts',
        detail: 'Multi-Cell Reinforced Box Culverts',
      },
      {
        label: 'Machinery Fleet',
        value: 'Full Paving Train',
        detail: 'Graders, Pavers & Vibratory Rollers',
      },
      {
        label: 'Compliance Code',
        value: 'KeRRA / KeNHA / BS',
        detail: 'Standard Road Design Manuals',
      },
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        caption:
          'Asphaltic concrete placement and surface dressing operations.',
        tag: 'Asphalt Paving',
      },
      {
      ...
      },
      {
        ...
        caption:
          'Paving train operation on county highway development project.',
        tag: 'Paving Train',
      },
      {
        ...
        caption:
          'Masonry drainage channels, bridges and box culverts for flood containment.',
        tag: 'Drainage',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            description:
              'Hot-mix asphalt laid and compacted to 98% Marshall density for heavy axle traffic loads.',
          },
          {
            name: 'Soil Stabilization & Base Construction',
            standard: 'AASHTO T180',
            description:
              'Cement-improved base course delivering high resilient modulus and moisture resistance.',
          },
          {
            name: 'Drainage & Hydraulic Structures',
            standard: 'Eurocode 2 / KeNHA Specs',
            description:
              'Hydraulically sized concrete box culverts and masonry side drains preventing road erosion.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Survey alignment coordinates, establish culvert invert levels, and sample subgrade soils.',
      ...
      },
      {
        ...
        objective:
          'Execute mass cut-and-fill, excavate roadside ditches, and cast reinforced concrete culverts.',
      ...
      },
      {
        ...
        objective:
          'Place crushed stone base, apply prime coat, and pave hot asphaltic concrete wearing course.',
        deliverables: [
          'Asphalt Marshall Test Logs',
          'Pavement Smoothness IRI Log',
        ],
      ...
      },
      {
        ...
        objective:
          'Install guardrails, apply thermoplastic road markings, erect road signs, and open to traffic.',
    ...
    technicalSpecs: [
      {
        parameter: 'Sub-Base California Bearing Ratio (CBR)',
        standardValue: 'CBR ≥ 30% at 95% MDD (BS-Heavy)',
        engineeringNotes: 'Ensures structural load transfer for heavy trucks',
      },
      {
        parameter: 'Asphalt Paving Temperature',
        standardValue: '140°C – 160°C at laydown',
        engineeringNotes: 'Compacted before temperature drops below 100°C',
      },
      {
        parameter: 'Culvert Concrete Characteristic Strength',
        standardValue: 'C30/37 (30 MPa at 28 days)',
        engineeringNotes: 'Waterproof concrete resistant to river scour',
      },
    ],
    faqs: [
      {
        question:
          'Does Green Ngoria undertake private mine haul road construction?',
        answer:
          'Yes. We design and construct heavy-duty haul roads engineered specifically for 60-tonne mining dump trucks and articulated loaders.',
      },
    ],
...

  {
    ...
    eyebrow: 'Civil Works',
    headline:
      'Water supply schemes, distribution reticulation, boreholes, and reinforced storage reservoirs',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Reinforced concrete water storage reservoir and sedimentation tank construction for municipal water distribution.',
      badge: 'Water Infrastructure',
    },
    keyMetrics: [
      {
        label: 'Scope Capabilities',
        value: 'Supply & Reticulation',
        detail: 'Reservoirs, Mains & Treatment',
      },
      {
        label: 'Pipeline Fusion',
        value: 'HDPE, D.I. & uPVC',
        detail: 'Electrofusion & Flanged Connections',
      },
      {
        label: 'Pumping Technology',
        value: 'Solar & Submersible',
        detail: 'Automated Variable Speed Drives',
      },
      {
        label: 'Pressure Testing',
        value: 'BS EN 805 / AWWA',
        detail: '1.5x Hydrostatic Pressure Verified',
      },
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        caption:
          'Pipeline trenching, bedding, and water reticulation pipe laying.',
        tag: 'Pipeline Laying',
      },
      {
        ...
        caption:
          'Elevated structural steel water storage tower and booster pump house.',
        tag: 'Water Tower',
      },
      {
        ...
        caption:
          'Pipe jointing, pressure reducing valves, and water distribution network.',
        ...
        items: [
          {
            ...
            description:
              'Crack-controlled concrete tanks with impermeable inner linings and baffled overflow systems.',
          },
          {
            name: 'High-Density Polyethylene (HDPE) Pipelines',
            standard: 'ISO 4427 / EN 12201',
            description:
              'Butt-fusion and electrofusion welded HDPE pressure pipes rated from PN10 to PN25.',
          },
          {
            name: 'Solar Hybrid Borehole Equipping',
            standard: 'EPRA / IEEE Pumping Specs',
            description:
              'High-efficiency submersible pumps powered by PV solar arrays with grid/diesel auto-switchover.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Conduct geophysical resistivity surveys, determine aquifer yield, and model pipe flow hydraulics.',
        deliverables: [
      ...
      },
      {
        ...
        objective:
          'Drill and case boreholes, cast concrete reservoirs, and erect elevated steel water towers.',
        deliverables: [
          'Borehole Test Pumping Log',
          'Water Quality Chemical Assay',
        ],
      ...
      },
      {
        ...
        objective:
          'Excavate trenches, lay HDPE/Ductile Iron pipes, and install air valves and washout chambers.',
        deliverables: [
          'Pipe Fusion Weld Logs',
          'Hydrostatic Pressure Test Sheets',
        ],
      ...
      },
      {
        ...
        objective:
          'Chlorinate and flush pipeline network, verify residual chlorine, and commission pump automation.',
        deliverables: [
          'Bacteriological Test Clearance',
          'As-Built Pipeline Map',
        ],
    ...
    technicalSpecs: [
      {
        parameter: 'Hydrostatic Pressure Test Rating',
        standardValue: '1.5x Maximum Operating Pressure for 24 hours',
        engineeringNotes: 'Zero pressure drop on sealed test sections',
      },
      {
        parameter: 'Concrete Water Retaining Crack Width Limit',
        standardValue: 'Wmax ≤ 0.2 mm (BS 8007)',
        engineeringNotes: 'Prevents leakage and internal rebar corrosion',
      },
      {
        parameter: 'Treated Potable Water Standard',
        standardValue: 'KEBS KS EAS 12 (Drinking Water Specs)',
        engineeringNotes: '0 CFU/100ml E. coli, residual chlorine 0.2–0.5 mg/L',
      },
    ],
    faqs: [
      {
        question:
          'Can Green Ngoria engineer industrial process water systems for mining sites?',
        answer:
          'Yes. We engineer raw water intake, settling ponds, filtration systems, and recycling water circuits tailored to mineral processing plants.',
      },
    ],
...

  {
    ...
    eyebrow: 'Engineering',
    headline:
      'Over a decade of heavy structural steel, industrial pipework, and plant erection',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Structural steel framing and pipe rack erection at an industrial bulk storage terminal.',
      badge: 'Heavy Mechanical Erection',
    },
    keyMetrics: [
      {
        label: 'Industry Experience',
        value: '10+ Years Delivery',
        detail: 'Oil Terminals & Power Sector',
      },
      {
        label: 'Welding Standards',
        value: 'ASME IX Certified',
        detail: '100% NDT on High-Pressure Lines',
      },
      {
        label: 'Mining Rigging',
        value: 'Headframes & Mills',
        detail: 'Shaft Hoisting & Heavy Steel',
      },
      {
        label: 'Lifting & Elevators',
        value: 'Schindler Lift Delivery',
        detail: 'Hotel Amahoro Lift Shaft Core',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'Structural steel erection and framing at a bulk storage terminal.',
      ...
      },
      {
        ...
        caption:
          'Industrial process pipework fabrication, manifolds, and installation.',
        tag: 'Process Piping',
      },
      {
        ...
        caption:
          'Mining rig and shaft headframe erection for underground extraction.',
        tag: 'Mining Rigging',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            description:
              'Heavy portal frames, crane runway beams, pipe bridges, and access stair towers.',
          },
          {
            name: 'Process Piping & Spool Fabrication',
            standard: 'ASME B31.3 / B31.4',
            description:
              'Carbon steel and stainless steel pipe spools for fuels, chemicals, and high-density slurries.',
          },
          {
            name: 'Coded Welding & Nondestructive Testing',
            standard: 'ASME IX / AWS D1.1',
            description:
              '100% visual inspection backed by radiographic, ultrasonic, and dye penetrant testing.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Develop 3D isometric piping blueprints, fabricate spools in workshop, and perform NDT.',
      ...
      },
      {
        ...
        objective:
          'Erect structural frames, hoist heavy machinery onto foundations, and align shafts using dual-axis lasers.',
      ...
      },
      {
        ...
        objective:
          'Torque all structural bolts to specification and hydro-test piping to 1.5x design pressure.',
        deliverables: [
          'Bolt Torque Audit Sheet',
      ...
      },
      {
        ...
        objective:
          'Lubricate bearings, check motor rotational directions, and conduct dry test runs.',
        deliverables: [
          'Cold Commissioning Dossier',
          'As-Built Mechanical Archive',
        ],
    ...
    technicalSpecs: [
      {
        parameter: 'Structural Steel Grade',
        standardValue: 'S275JR / S355JR (EN 10025)',
        engineeringNotes: 'High yield strength certified structural steel',
      },
      {
        parameter: 'Shaft Laser Alignment Tolerance',
        standardValue: '< 0.05 mm radial / axial runout',
        engineeringNotes: 'Ensures zero vibration on heavy rotary equipment',
      },
      {
        parameter: 'Welding NDT Acceptance',
        standardValue: 'ASME B31.3 Severe Cyclic Conditions criteria',
        engineeringNotes: 'Zero crack or lack-of-fusion defects allowed',
      },
    ],
    faqs: [
      {
        question:
          'Does Green Ngoria maintain certified mobile crane operators and riggers?',
        answer:
          'Yes. All lifting operations are planned by certified rigging engineers with written lift plans and calibrated rigging tackle.',
      },
    ],
...

  {
    ...
    eyebrow: 'Engineering',
    headline:
      'High-voltage switchyards, motor control centers (MCC), automation, and preventive maintenance',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'High-voltage switchyard and power transformer substation infrastructure for industrial facilities.',
      badge: 'High-Voltage Engineering',
    },
    keyMetrics: [
      {
        label: 'Voltage Coverage',
        value: 'LV, MV & High-Voltage',
        detail: 'Switchyards & Power Distribution',
      },
      {
        label: 'Compliance Code',
        value: 'IEC 60364 / IEEE',
        detail: 'EPRA Class A Registered',
      },
      {
        label: 'Automation & Drives',
        value: 'PLC, SCADA & VFDs',
        detail: 'Automated Motor Control Centers',
      },
      {
        label: 'Testing Equipment',
        value: 'Calibrated Meggers',
        detail: 'Insulation & Earth Loop Testing',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'High-voltage switchyard and substation transformer infrastructure.',
        tag: 'High Voltage',
      },
      {
        ...
        caption:
          'Industrial distribution board installation and precision cabling.',
        tag: 'Switchboards',
      },
      {
      ...
      },
      {
        ...
        caption:
          'Testing, commissioning, and preventive maintenance diagnostics.',
        tag: 'Testing',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            description:
              'Form 4 segregated switchboards with integrated motor protection and PLC logic.',
          },
          {
            name: 'Substation & Power Factor Correction',
            standard: 'IEEE 519 / IEC 60076',
            description:
              'Oil/dry type transformers and automatic capacitor banks maintaining PF > 0.95.',
          },
          {
            name: 'Grounding & Lightning Protection',
            standard: 'BS 7430 / IEC 62305',
            description:
              'Copper mesh grounding networks with chemical earth rods ensuring safe fault dissipation.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Calculate maximum demand, design Single Line Diagrams (SLD), and size transformers and cables.',
      ...
      },
      {
        ...
        objective:
          'Install cable trays, pull armored power cables, mount MCC cabinets, and wire field instruments.',
      ...
      },
      {
        ...
        objective:
          'Perform high-voltage insulation tests, verify earth resistance, and simulate PLC control logic.',
      ...
      },
      {
        ...
        objective:
          'Energize substation under utility supervision, verify phase rotation, and conduct load run.',
        deliverables: [
          'Electrical Commissioning Certificate',
          'As-Built Schematics',
        ],
    ...
    technicalSpecs: [
      {
        parameter: 'Earth Grounding Resistance',
        standardValue: '< 1.0 Ohm across main earth grid',
        engineeringNotes: 'Protects sensitive electronic PLC equipment',
      },
      {
        parameter: 'Insulation Resistance (Megger Test)',
        standardValue: '> 100 Megaohms at 1000V DC test voltage',
        engineeringNotes: 'Mandatory before any cable energization',
      },
      {
        parameter: 'Power Factor Target',
        standardValue: 'Cos φ ≥ 0.95 maintained automatically',
        engineeringNotes:
          'Eliminates utility reactive power penalty surcharges',
      },
    ],
    reach: {
    ...
    faqs: [
      {
        question:
          'Does Green Ngoria provide Class A EPRA certified electrical installations?',
        answer:
          'Yes. Our electrical engineers and installation technicians hold full statutory licensing with EPRA and local utility authorizations.',
      },
    ],
...

  {
    ...
    headline:
      'Six service lines across the petroleum value chain: wholesale fuels, lubricants, and depot EPC',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Turnkey petroleum depot and bulk fuel storage terminal infrastructure with automated dispensing gantries.',
      badge: 'Petroleum & Depot Infrastructure',
    },
    keyMetrics: [
      {
        label: 'County Reach',
        value: 'All 47 Counties',
        detail: 'Nationwide Fuel Optimization',
      },
      {
        label: 'Service Lines',
        value: '6 Value Streams',
        detail: 'Fuel, Lubes, Chemicals, Logistics & EPC',
      },
      {
        label: 'Compliance Code',
        value: 'EPRA / NEMA Compliant',
        detail: 'Fully Licensed Fuel Reseller',
      },
      {
        label: 'Logistics Fleet',
        value: 'Calibrated Tankers',
        detail: 'Tamper-Evident GPS Monitored',
      },
    ],
    gallery: [
      {
        ...
        caption:
          'On-site petroleum depot and bulk storage terminal infrastructure.',
        tag: 'Bulk Depot',
      },
      {
        ...
        caption:
          'Retail forecourt fuel dispensing and service station canopy systems.',
      ...
      },
      {
        ...
        caption:
          'High-technology engine oils, hydraulic fluids, and specialty lubricants.',
        tag: 'Lubricants',
      },
    ],
    scope: [
        ...
        items: [
          {
            ...
            description:
              'Direct pipeline allocation from KPC terminals with certificate of quality verification.',
          },
          {
            name: 'Heavy Duty Mining & Fleet Lubricants',
            standard: 'API / SAE / ISO VG',
            description:
              'Hydraulic oils (ISO 46/68), heavy gear lubes (85W-140), and 15W-40 CI-4 diesel engine oils.',
          },
          {
            name: 'Depot & Retail Forecourt Construction',
            standard: 'EPRA Petroleum Specs',
            description:
              'Double-wall underground tanks (UST), spill containment sumps, and digital fuel management.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Analyze client fuel consumption rates, on-site storage capacity, and delivery schedules.',
      ...
      },
      {
        ...
        objective:
          'Load calibrated road tankers at Kenya Pipeline Company (KPC) with density and flashpoint verification.',
      ...
      },
      {
        ...
        objective:
          'Transport fuel under GPS tracking and discharge into client storage tanks with dip-stick verification.',
    ...
    technicalSpecs: [
      {
        parameter: 'Diesel (AGO) Sulfur Content',
        standardValue: '< 50 ppm (Ultra-Low Sulfur Standard)',
        engineeringNotes:
          'Protects modern common-rail electronic diesel engines',
      },
      {
        parameter: 'Underground Tank Pressure Rating',
        standardValue: 'UL 58 / EN 12285-1 Double-Wall',
        engineeringNotes:
          'Withstands hydrostatic ground pressure with interstitial leak monitoring',
      },
      {
        parameter: 'Dispensing Accuracy',
        standardValue: '± 0.25% calibrated with Weights & Measures stamp',
        engineeringNotes: 'Official statutory calibration',
      },
    ],
    groups: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          'We supply full road tanker loads (10,000 to 35,000 litres) directly to mining sites, agricultural estates, and commercial depots.',
      },
    ],
...

  {
    ...
    eyebrow: 'Importation & Supply',
    headline:
      'Certified hardwood, heavy construction crane mats, and bespoke structural timber',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Certified sawn hardwood timber stock graded to D70 / D60 standards for heavy construction and marine piling.',
      badge: 'Certified Timber Supply',
    },
    keyMetrics: [
      {
        label: 'Timber Grades',
        value: 'D70 & D60 Hardwood',
        detail: 'Tropical & Coniferous Species',
      },
      {
        label: 'Preservative Treatment',
        value: 'Vacuum Pressure CCA',
        detail: 'BS 5589 / KEBS Compliant',
      },
      {
        label: 'Heavy Civil Products',
        value: 'Crane Mats & Piling',
        detail: 'Railroad Ties & Teak Decking',
      },
      {
        label: 'Yard Stock',
        value: 'Ex-Stock Dispatch',
        detail: 'Nairobi & Regional Yard Inventory',
      },
    ],
    gallery: [
      {
      ...
      },
      {
        ...
        caption:
          'Heavy-duty timber planks for construction, decking, and marine piling.',
        ...
        items: [
          {
            ...
            description:
              'Bolted heavy timber mats distributing 100-tonne mobile crane ground pressures.',
          },
          {
            name: 'Pressure-Treated Utility Poles',
            standard: 'KEBS KS 516 / BS 1990',
            description:
              'Creosote or CCA pressure-treated transmission poles with guaranteed 25+ year lifespan.',
          },
          {
            name: 'Marine Piling & Shoring Timbers',
            standard: 'ASTM D25 / BS 5268',
            description:
              'Dense, decay-resistant tropical hardwood piles for port quays and bridge abutments.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Determine structural load, species density, dimensions, and moisture content requirements.',
        deliverables: [
          'Timber Specification Match',
          'FSC / Chain-of-Custody Cert',
        ],
      ...
      },
      {
        ...
        objective:
          'Precision saw logs to dimensions, kiln dry, and apply vacuum pressure preservative treatment.',
        deliverables: [
          'Treatment Chemical Penetration Cert',
          'Moisture Test Log',
        ],
      ...
      },
      {
        ...
        objective:
          'Bundle, strap, and transport timber lots directly to the client construction site or fabrication yard.',
    ...
    technicalSpecs: [
      {
        parameter: 'D70 Hardwood Density',
        standardValue: '950 – 1,150 kg/m³ air-dry',
        engineeringNotes:
          'Extremely dense, naturally resistant to termites and rot',
      },
      {
        parameter: 'Moisture Content (Kiln Dried)',
        standardValue: '< 15% – 18% moisture content',
        engineeringNotes: 'Prevents warping and dimensional shrinkage',
      },
      {
        parameter: 'Chemical Preservative Retention',
        standardValue: 'CCA Type C (Minimum 12 kg/m³ retention)',
        engineeringNotes: 'Deep vacuum pressure penetration for ground contact',
      },
    ],
    reach: {
    ...
    faqs: [
      {
        question:
          'Can Green Ngoria supply custom-milled large dimension timbers?',
        answer:
          'Yes. We can custom mill heavy timbers up to 400mm x 400mm section and lengths up to 8 metres according to engineering specifications.',
      },
    ],
...

  {
    ...
    eyebrow: 'Importation & Supply',
    headline:
      'Consolidated procurement, corporate merchandise, office consumables, and humanitarian relief supplies',
    summary:
    ...
    primaryImage: {
      ...
      caption:
        'Import container discharge and consolidated logistics distribution for corporate and institutional procurement.',
    ...
    keyMetrics: [
      {
        ...
        detail: 'Banks, Humanitarian Agencies & Government',
      },
      {
        label: 'Supply Speed',
        value: 'Rapid Dispatch',
        detail: 'Ex-Warehouse Stock & Fleet Delivery',
      },
      {
        label: 'Quality Verification',
        value: '100% Inspected',
        detail: 'Specification Verification & Guarantees',
      },
      {
        label: 'Logistics Footprint',
        value: 'East Africa Wide',
    ...
    gallery: [
      {
        ...
        caption:
          'Container discharge and import distribution logistics for corporate clients.',
      ...
      },
      {
        ...
        caption:
          'Consolidated corporate, NGO, and relief supplies staging yard.',
        ...
        items: [
          {
            ...
            description:
              'Bulk sourcing of office furniture, IT hardware, consumables, and corporate branded goods.',
          },
          {
            name: 'Humanitarian & Relief Supplies',
            description:
              'Emergency tents, tarpaulins, water purification units, hygiene kits, and emergency provisions.',
          },
        ],
      },
    ],
    lifecyclePhases: [
      {
        ...
        objective:
          'Review bill of quantities, identify verified suppliers, and issue line-item quotation.',
      ...
      },
      {
        ...
        objective:
          'Verify goods against sample specifications and dispatch via dedicated transport fleet.',
    ...
    technicalSpecs: [
      {
        parameter: 'Procurement Turnaround',
        standardValue: '24 to 72 Hours for In-Stock Items',
        engineeringNotes: 'Nationwide delivery capability',
      },
      {
        parameter: 'Quality Assurance',
        standardValue: '100% Pre-Shipment Inspection',
        engineeringNotes: 'Backed by manufacturer warranty',
      },
    ],
    reach: {
    ...
    faqs: [
      {
        question:
          'How do corporate clients establish supply framework agreements?',
        answer:
          'We establish structured service level agreements (SLAs) with fixed pricing schedules and guaranteed delivery lead times for annual procurement contracts.',
      },
    ],
